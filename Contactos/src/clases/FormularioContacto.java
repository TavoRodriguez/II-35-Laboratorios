...
public class FormularioContacto extends javax.swing.JFrame {
    ...
    final String TITLE = "Contact Center GR Soluciones S.A"; // Título de la ventana
    ...
    private void initComponents() {
        ...
        bBusqueA.setText("Contact center");
        ...
        btnColgar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/botones/llamada-perdida.png"))); // NOI18N
        ...
        jLabel9.setText("Tiempo en Llamada:");

        lblTiempo.setText("00:00:00");

        jScrollPane2.setViewportView(listAtendidos);

        jScrollPane3.setViewportView(listPendientes);
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtAtendiendo, javax.swing.GroupLayout.PREFERRED_SIZE, 299, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblTiempo, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(203, 203, 203)
    ...
    private void bBusqueAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bBusqueAActionPerformed
        ...
        if (estadoB) {
            ...
            int h = INITIAL_HEIGHT + jPanel5.getHeight()+ 20;
            super.setSize(w,h);
    ...
    private void actualizarComponentes(Contacto atendido) {
        ...
        if (atendido != null) {
            pila.push(atendido); // Guardar en la pila
        }

        // Actualiza la lista de atendidos desde la pila
        lmAtendidos.clear();
        for (Contacto contacto : pila) {
            lmAtendidos.addElement(contacto.getNombre() + " " + contacto.getApellidos());
        }
    ...
    private void btnSiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSiguienteActionPerformed
        ...
        Contacto siguiente = cola.poll(); // Sacar el siguiente contacto de la cola
        if (siguiente == null) {
            JOptionPane.showMessageDialog(null, "No hay personas por atender.");
            btnSiguiente.setEnabled(false);
            btnContactar.setEnabled(true);
            btnLlamar.setEnabled(false);
            txtAtendiendo.setText(" ");
        } else {
            btnLlamar.setEnabled(true);
            txtAtendiendo.setText(siguiente.getNombre() + " " + siguiente.getApellidos());
            actualizarComponentes(siguiente);
    ...
    private void btnLlamarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLlamarActionPerformed
        ...
        timer.start(); // Empezar el cronómetro
